<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-digits1742/1?page=2&difficulty=School&sortBy=accuracy">Sum Of Digits</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number,&nbsp;<strong>N</strong>. Find the sum of all the digits of N</span><br>
&nbsp;</p>
